...
const LineChart = (props) => {
  ...
  const { innerWidth: chartWidth, innerHeight: chartHeight } = window;
                  ...
                  return [
                    {
                      ...
                      mutation: (props) => {
                        if (props.datum.action === 'none') {
                          return {
                            text: `Started trading with $${props.datum.cash} 
                      on ${props.datum.x.toDateString()}`,
                          };
                        }
                        return {
                          text: `${props.datum.action.toUpperCase()} ${
                            props.datum.shares
                          } shares for $${props.datum.y}
